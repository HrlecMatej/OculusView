...
namespace GMap.NET.MapProviders
{
    ...
    public abstract class GoogleMapProviderBase : GMapProvider, RoutingProvider, GeocodingProvider, DirectionsProvider
    {
        ...
        {
            Debug.WriteLine("Izbran server: " + Server);
            MaxZoom = null;
            RefererUrl = string.Format("http://maps.{0}/", Server);
            Copyright = string.Format("©{0} Google Maps", DateTime.Today.Year);
        }

        public readonly string ServerAPIs = "googleapis.com";
        public readonly string Server = "google.com";
        ...
        /// </summary>
        public string ApiKey = "AIzaSyCMoPcfsqezHY--VM7mKC6uJd644b273Ko";
        ...
        public GeoCoderStatusCode GetPanoIds(PointLatLng location, out List<string> panoIdList)
        {
            return GetPanoIdFromReverseGeocoderUrl(MakeStreetViewUrl(location, LanguageStr), out panoIdList);
        }
        ...
        string MakeStreetViewUrl(PointLatLng pt, string language)
        {
            return string.Format(CultureInfo.InvariantCulture, StreetViewUrlFormat, Server, pt.Lat, pt.Lng, language);
        }

        GeoCoderStatusCode GetPanoIdFromReverseGeocoderUrl(string url, out List<string> panoIdList)
        {
            ...
            try
            {
                ...
                bool cache = false;
                //Debug.WriteLine("Url street view: " + url);
                ...
                if (!string.IsNullOrEmpty(reverse))
                {
                    #region -- xml response --
                    //<panorama>
                    //    <data_properties image_width="13312" image_height="6656" tile_width="512" tile_height="512" image_date="2013-09" pano_id="uyu6kayK95wR4srpxImGmA" imagery_type="1" num_zoom_levels="5" lat="46.311853" lng="15.143092" original_lat="46.311866" original_lng="15.143117" elevation_wgs84_m="460.286430" best_view_direction_deg="206.19797" elevation_egm96_m="413.102966">
                    //        <copyright>© 2015 Google</copyright>
                    //        <text>Ponikva pri Žalcu</text>
                    //        <street_range>5</street_range>
                    //        <region>Ponikva pri Žalcu, Žalec</region>
                    //        <country>Slovenija</country>
                    //    </data_properties>
                    //    <projection_properties projection_type="spherical" pano_yaw_deg="87.159996" tilt_yaw_deg="-161.59999" tilt_pitch_deg="1.25"/>
                    //    <annotation_properties>
                    //        <link yaw_deg="113.5" pano_id="OyYu9TkBff3_j0wpl115og" road_argb="0x80fdf872">
                    //        <link_text>Ponikva pri Žalcu</link_text>
                    //        </link>
                    //        <link yaw_deg="270.78" pano_id="Zk8M7apqRZ8uFGeUpRRpvQ" road_argb="0x80fdf872">
                    //        <link_text>Ponikva pri Žalcu</link_text>
                    //        </link>
                    //        <link yaw_deg="88.65" pano_id="XFBmLK7V4x3OoT6u_fwAaQ" road_argb="0x80fdf872">
                    //        <link_text>Ponikva pri Žalcu</link_text>
                    //        </link>
                    //    </annotation_properties>
                    //</panorama>
                    ...
                    panoIdList = new List<String>();

                    //XmlNodeList l = doc.SelectNodes("//result");

                    XmlNode nn = doc.SelectSingleNode("//data_properties");

                    if (nn != null)
                    {

                        string panoId = nn.Attributes["pano_id"].Value;
        ...
        static readonly string StreetViewUrlFormat = "http://maps.{0}/cbk?output=xml&ll={1},{2}&language={3}&sensor=false";
